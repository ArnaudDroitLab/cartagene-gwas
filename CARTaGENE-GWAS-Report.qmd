...
-   [Why use a biased *gene-centric approach*, instead of true GWAS (further discussed in @sec-post-GWAS)?]{fg="red"}. If ou really want to use a *candidate-gene approach*, report to [A current guide to candidate gene association studies](https://www.cell.com/trends/genetics/abstract/S0168-9525), from @david2021tig. 
...
### Retrieve automatically variants of interest {#sec-post-GWAS}

This analysis is not formally a GWAS study, but rather a *gene-candidate* study, pre-selecting genes based on prior knowledge and/or intuition.
