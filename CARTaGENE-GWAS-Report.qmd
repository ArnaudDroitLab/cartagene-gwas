...
## Mapping and aligning sequences

- Folder `genotype/genotypage`: 
  - BAM: Stores sequence alignments (used for NGS data).
  - BED: Stores genomic regions of interest (used for visualizing and analyzing specific genomic areas).
  - BIM: Stores SNP information (used in GWAS with PLINK).
  - FAM: Stores individual and pedigree data (used with BIM in PLINK for genetic studies).
  
- Folder `genotype/imputation`
  - [Quality control and imputation protocols](https://cartagene.qc.ca/fr/chercheurs/donnees-genetiques.html)

## GWAS HDAC9

### PCA 

Genotypes were split into five datasets with five different genotyping arrays:
