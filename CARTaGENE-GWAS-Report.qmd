...
```{bash}
cd "/mnt/projects_tn01/Cartagene"
```
...
- [multi-locus genome-wide association study (GWAS) using `DArTseq`](https://bmcgenomics.biomedcentral.com/articles/10.1186/s12864-025-11344-z)
- [`brms` pakcage](https://bmcbioinformatics.biomedcentral.com/articles/10.1186/s12859-025-06077-5)
