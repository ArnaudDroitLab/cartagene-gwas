...
1. Use of `PLINK2 + glm` with the first 10 principal components as covariates:
  ...
  - `Error: Cannot proceed with --glm regression on phenotype 'TACAIX', since variance inflation factor for covariate 'PC2' is too high` -> try removing other spurious and highly-correlated covariates, or increase variance inflation threshold. [Discussion and visualisations on [*VIF influence*](https://www.linkedin.com/feed/update/urn:li:activity:7308463515432833026/)]{fg="red"}.
